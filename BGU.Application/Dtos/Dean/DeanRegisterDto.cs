...
public class DeanRegisterDtoValidator : AbstractValidator<DeanRegisterDto>
{
    public DeanRegisterDtoValidator()
    {
        ...
        RuleFor(x => x.FacultyId).NotEmpty().WithMessage("FacultyId is required");
