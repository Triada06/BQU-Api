...
public interface ITaughtSubjectService
{
    ...
    Task<ApiResult<string>> UpdateAsync(string id, UpdateTaughtSubjectRequest taughtSubject);
    Task<ApiResult<IEnumerable<GetTaughtSubjectDto>?>> GetAllAsync(int page, int pageSize, bool tracking = false);
