...
public class RoomService(IRoomRepository roomRepository) : IRoomService
{
    ...
    {
        var rooms = (await roomRepository.GetAllPaginatedAsync(null,page, pageSize, tracking)).Items.ToList();
    ...
    public async Task<CreateRoomResponse> CreateAsync(CreateRoomRequest request)
    {
        ...
        return new CreateRoomResponse(new RoomDto(room.Id, room.Name, room.Capacity),
    ...
    public async Task<GetRoomByIdResponse> GetByIdAsync(string id, bool tracking = false)
    {
        ...
        return room is null
            ...
            : new GetRoomByIdResponse(new RoomDto(room.Id, room.Name, room.Capacity),
                StatusCode.Ok, true, ResponseMessages.Success);
    }
    ...
    public async Task<UpdateRoomResponse> UpdateAsync(string id, UpdateRoomRequest request)
    {
        ...
        return new UpdateRoomResponse(new RoomDto(room.Id, room.Name, room.Capacity),
            StatusCode.Ok, true, ResponseMessages.Success);
    }
