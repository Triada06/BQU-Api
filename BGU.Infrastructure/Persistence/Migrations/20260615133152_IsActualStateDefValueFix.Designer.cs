...
namespace BGU.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260615133152_IsActualStateDefValueFix")]
    partial class IsActualStateDefValueFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BGU.Core.Entities.IndependentWork", b =>
                {
                    ...
                    b.ToTable("IndependentWorks", t =>
                        {
                            t.HasCheckConstraint("CK_Number_Range", "\"Number\" >= 0 AND \"Number\" <= 10");
                        });
                });

            modelBuilder.Entity("BGU.Core.Entities.LibraryBook", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BGU.Core.Entities.Notification", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BGU.Core.Entities.StudentSubjectResult", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("IsExamEligible")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("BGU.Core.Entities.LibraryBook", b =>
                {
                    b.HasOne("BGU.Core.Entities.AppUser", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("BGU.Core.Entities.Student", b =>
                {
                    ...
                    b.HasOne("BGU.Core.Entities.AppUser", "AppUser")
                        .WithOne()
                        .HasForeignKey("BGU.Core.Entities.Student", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BGU.Core.Entities.Teacher", b =>
                {
                    b.HasOne("BGU.Core.Entities.AppUser", "AppUser")
                        .WithOne()
                        .HasForeignKey("BGU.Core.Entities.Teacher", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
